...
def get_first_anekdot():
    ...
    for article in articles_topicbox:
        ...
        if article_id:
            ...
            print(f"{article_id} | {article_anekdot}")
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        # article_id = article.find_parent(class_="rates").attrs.get("data-id"):
        # if article_id:
        #     print(article_id.get_text())
        # print(article_id)

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        # article_id = article.find("div",class_="rates")
        # if article_id.get_text("data-id"):
        #     print(article_id.get_text())
